...
public class PedidoJpaController implements Serializable {
    ...
    public PedidoJpaController(){
        emf= Persistence.createEntityManagerFactory("com.mycompany_producto5JPAPU");
    }
    ...
    try {
        ...
        // Ordenar de manera descendente por idPedido
        cq.orderBy(cb.desc(root.get("idPedido")));

        TypedQuery<Pedido> q = em.createQuery(cq);
        q.setMaxResults(1); // Obtener solo un resultado (el último)

        List<Pedido> resultList = q.getResultList();
