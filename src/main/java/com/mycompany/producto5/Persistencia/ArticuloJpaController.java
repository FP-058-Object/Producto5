...
public class ArticuloJpaController implements Serializable {
    ...
    public Articulo findLastArticulo() {
        ...
        try {
            ...
            // Ordenar de manera descendente por idArticulo
            cq.orderBy(cb.desc(root.get("idArticulo")));

            TypedQuery<Articulo> q = em.createQuery(cq);
            q.setMaxResults(1); // Obtener solo un resultado (el último)

            List<Articulo> resultList = q.getResultList();
